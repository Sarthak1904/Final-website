...
const projects: Project[] = [
    {
        title: "PharmaSight",
        description: "A machine learning platform designed to transform drug classification.",
        year: "2025",
        link: "https://github.com/Sarthak1904/PharmaSight",
        image: "/images/pharmasight-hover.jpg",
    },
    {
        title: "Smart Bank",
        description: "Modern banking, seamless full-stack experience",
        year: "2025",
        link: "https://github.com/Sarthak1904/smart-bank",
        image: "/images/smart-bank-hover.jpg",
    },
    {
        title: "A-Log Intel",
        description: "End-to-End Delivery Analytics Platform",
        year: "2025",
        link: "https://github.com/Sarthak1904/amazonlogistic_intelligence_dashboard",
    ...
    {
        title: "Cudaspatia",
        description: "A high-performance spatial query processing system that demonstrates low-latency spatial operations",
        year: "2024",
        link: "https://github.com/Sarthak1904/Cudaspatia",
...
export function ProjectShowcase() {
    ...
    return (
        ...
        >
            ...
            <div
                className="pointer-events-none fixed z-50 overflow-hidden rounded-xl shadow-2xl transition-all duration-300 ease-out"
                style={{
